            ...
            <div className="text-center">
              ...
              >
                ...
                <p className="text-xl text-gray-700 mb-8 max-w-3xl mx-auto">
                  Build brand awareness and engage your audience with strategic social media marketing across all platforms.
                </p>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-8 max-w-2xl mx-auto">
                  ...
                  <p className="text-yellow-700 mb-6">
                    We're developing comprehensive social media marketing strategies to help you build a strong online presence and connect with your audience.
                  </p>
