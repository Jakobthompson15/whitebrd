            ...
            <div className="text-center">
              ...
              >
                ...
                <p className="text-xl text-gray-700 mb-8 max-w-3xl mx-auto">
                  Engage your audience and drive conversions with strategic content marketing that builds authority and trust.
                </p>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-8 max-w-2xl mx-auto">
                  ...
                  <p className="text-yellow-700 mb-6">
                    We're crafting comprehensive content marketing strategies to help you attract, engage, and convert your target audience through valuable content.
                  </p>
