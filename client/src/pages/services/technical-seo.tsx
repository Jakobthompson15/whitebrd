            ...
            <div className="text-center">
              ...
              >
                ...
                <p className="text-xl text-gray-700 mb-8 max-w-3xl mx-auto">
                  Optimize your website's technical foundation to improve search engine crawling, indexing, and overall performance.
                </p>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-8 max-w-2xl mx-auto">
                  ...
                  <p className="text-yellow-700 mb-6">
                    We're building advanced technical SEO auditing and optimization services to ensure your website meets all search engine requirements for maximum visibility.
                  </p>
