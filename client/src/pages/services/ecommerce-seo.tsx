            ...
            <div className="text-center">
              ...
              >
                ...
                <p className="text-xl text-gray-700 mb-8 max-w-3xl mx-auto">
                  Drive more organic traffic and increase sales for your online store with our specialized e-commerce SEO strategies.
                </p>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-8 max-w-2xl mx-auto">
                  ...
                  <p className="text-yellow-700 mb-6">
                    We're crafting the perfect e-commerce SEO solution to help your online store dominate search results and maximize conversions.
                  </p>
